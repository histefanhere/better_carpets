...
execute as @s[tag=on_magenta_119] unless block ~ ~ ~ magenta_carpet run function bc:magenta_119/leaving
...
execute as @s[tag=on_orange] unless block ~ ~ ~ orange_carpet run function bc:orange/leaving
execute as @s[tag=on_lime] unless block ~ ~ ~ lime_carpet run function bc:lime/leaving

#  execute as @s[tag=on_magenta] unless block ~ ~ ~ magenta_carpet run function bc:magenta/leaving
execute as @s[tag=on_light_blue] unless block ~ ~ ~ light_blue_carpet run function bc:light_blue/leaving
execute as @s[tag=on_pink] unless block ~ ~ ~ pink_carpet run function bc:pink/leaving
execute as @s[tag=on_gray] unless block ~ ~ ~ gray_carpet run function bc:gray/leaving
execute as @s[tag=on_light_gray] unless block ~ ~ ~ light_gray_carpet run function bc:light_gray/leaving
execute as @s[tag=on_cyan] unless block ~ ~ ~ cyan_carpet run function bc:cyan/leaving
