...
# Server carpets
execute as @s[tag=bc_title_yellow_wilderness] run tag @s remove bc_title_yellow_wilderness
execute as @s[tag=bc_title_white_spawn] run tag @s remove bc_title_white_spawn
execute as @s[tag=bc_title_white_nether_hub] run tag @s remove bc_title_white_nether_hub
execute as @s[tag=bc_title_white_end_portal] run tag @s remove bc_title_white_end_portal
...
execute as @s[tag=bc_title_cyan] run tag @s remove bc_title_cyan
execute as @s[tag=bc_title_brown] run tag @s remove bc_title_brown
execute as @s[tag=bc_title_black] run tag @s remove bc_title_black

tag @s remove bc_titling
