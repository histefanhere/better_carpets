...
execute unless entity @a[tag=bc_item_dest] run function bc:carpets/special/orange/update_title

# 2 - There is already someone waiting on a green carpet to warp too
#   - Begin warping
execute if entity @a[tag=bc_item_dest] run function bc:carpets/special/orange/start_warp
